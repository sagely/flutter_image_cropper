...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  if ([@"cropImage" isEqualToString:call.method]) {
      ...
      BOOL hideRotateControls = call.arguments[@"hide_rotate_controls"];
      ...
      [cropViewController setRotateButtonsHidden:hideRotateControls];
...
- (void)cropViewController:(TOCropViewController *)cropViewController didCropToImage:(UIImage *)image withRect:(CGRect)cropRect angle:(NSInteger)angle
{
    ...
    if ([[NSFileManager defaultManager] createFileAtPath:tmpPath contents:data attributes:nil]) {
        NSDictionary* toReturn = @{@"filePath": tmpPath,
                                   @"x": [NSString stringWithFormat:@"%f", cropRect.origin.x],
                                   @"y": [NSString stringWithFormat:@"%f", cropRect.origin.y],
                                   @"w": [NSString stringWithFormat:@"%f", cropRect.size.width],
                                   @"h": [NSString stringWithFormat:@"%f", cropRect.size.height],
                                   @"x2": [NSString stringWithFormat:@"%f", (cropRect.origin.x + cropRect.size.width)],
                                   @"y2": [NSString stringWithFormat:@"%f", (cropRect.origin.y + cropRect.size.height)]};
